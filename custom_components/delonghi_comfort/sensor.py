...
# Mode 4 does not exist on this device.
_STATUS_MAP = {1: "on", 2: "off"}
_MODE_MAP = {1: "cooling", 2: "dehumidification", 3: "fan_only", 5: "real_feel"}
...
class DeLonghiSensor(CoordinatorEntity, SensorEntity):
    ...
    def native_value(self) -> Any:
        """Return the sensor value with human-readable mapping where appropriate."""
    ...
    def available(self) -> bool:
        """Return True only if this sensor key is in coordinator data."""
        return (
            super().available
